...
1.  **Configuração do Discord:** Crie um Webhook no seu canal do Discord e insira a URL no campo correspondente do bot.
2.  **Defina o Radar:** Escolha o valor mínimo de XP (ex: 150.000) para o bot considerar um "Rush".
3.  **Inicie o Bot:** Clique em `Start` e o bot começará a monitorar.
